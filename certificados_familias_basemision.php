...
$jefeSI = Familia::where('base_misiones',$basemisiones)->where('cod_municipio',$municipio)->where('cod_parroquia',$parroquia)->where('bodega',$bodega_id)->where('huella_certificada',$tipo)->get();
